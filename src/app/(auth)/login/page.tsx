...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-[#0b0e1a] px-4 overflow-hidden">
      {/* Grid */}
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-3 text-lg font-semibold text-white">Welcome back</p>
          <p className="mt-1 text-xs text-zinc-500">Sign in to your account</p>
        </div>
        ...
        <div className="rounded-xl border border-white/8 bg-white/3 p-8 backdrop-blur-sm">
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-3 rounded-md border border-white/10 bg-white px-4 py-3 text-sm font-semibold text-zinc-800 transition-all hover:bg-zinc-100 hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed"
          >
